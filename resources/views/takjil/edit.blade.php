...
<body>
    ...
    <div class="container">
        <div class="row">
            <form action="/takjil/update/{{$takjil->id}}" method="POST">
                @csrf
                <div class="form-group">
                  <label>Nama Takjil</label>
                  <input name="namaTakjil" value="{{$takjil->nama_takjil}}" type="text" class="form-control">
                </div>
                <div class="form-group">
                  <label>Harga</label>
                  <input name="hargaTakjil" value="{{$takjil->harga_takjil}}" type="text" class="form-control">
                </div>
                <div class="form-group">
                  <label>Jumlah</label>
                  <input name="jumlahTakjil" value="{{$takjil->jumlah_takjil}}" type="text" class="form-control">
                </div>
