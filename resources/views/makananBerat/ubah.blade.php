...
<form action="/maber/perbarui/{{$data->id}}" method="POST">
@csrf
  <div class="form-group">
    <label>Nama makanan</label>
    <input value="{{$data->nama_makanan}}" name="namaMakanan" type="text" class="form-control">
  </div>
  
  <div class="form-group">
    <label>Harga makanan</label>
    <input value="{{$data->harga_makanan}}" name="hargaMakanan" type="text" class="form-control" >
  </div>

  <div class="form-group">
    <label>Jumlah makanan</label>
    <input value="{{$data->jumlah_makanan}}"name="jumlahMakanan" type="text" class="form-control">
  </div>
